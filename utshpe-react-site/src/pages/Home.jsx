...
import slide1 from "../assets/Home_Page/slideshow1.jpg";
import slide2 from "../assets/Home_Page/slideshow2.jpg";
import slide3 from "../assets/Home_Page/slideshow3.jpg";
import slide4 from "../assets/Home_Page/slideshow4.jpg";
import slide5 from "../assets//Home_Page/slideshow5.jpg"
import slide6 from "../assets//Home_Page/slideshow6.jpg"
...
function Home() {
  ...
  const sponsorImages = [];
  const req = require.context("../assets/sponsors", false, /\.(png)$/);
  req.keys().forEach((fileName) => {
    sponsorImages.push(req(fileName));
  });
