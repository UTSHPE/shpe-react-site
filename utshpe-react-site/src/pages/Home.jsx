...
function Home() {
  ...
  //     <div className="min-h-screen w-full bg-[#fffdf0] text-gray-900 relative flex flex-col overflow-hidden">
      ...
      {showMainContent && (
        <>
          <main className="w-full flex flex-col gap-24 mt-12">
            ...
            {/* Hero Section */}
            <section className="w-full py-20 flex flex-col items-center text-center px-6 bg-[#001F5B] text-white">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-4xl font-bold mb-3 bg-gradient-to-r from-[#FD652F] to-[#72A9BE] bg-clip-text text-transparent">
                  UT SHPE
                </h2>
                <h3 className="text-2xl mb-4 text-[#72A9BE]">The University of Texas at Austin</h3>
