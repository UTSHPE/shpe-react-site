...
const ProfileCard = ({ member, index, hoveredCard, setHoveredCard, cardId }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FCF0D6] text-gray-900 flex flex-col">
      ...
      <motion.section 
        ...
        className="w-full py-32 md:py-40 text-center px-6 bg-gradient-to-r from-[#FD652F] to-[#72A9BE] text-white"
      >
        <motion.h1 
        ...
        >
          ...
          of them carries vital responsibilities that sustain our chapter's vision and mission, and
          they lead by example with perseverance, dedication, and a passion for service.
        </motion.p>
      </motion.section>
